...
Version des beschriebenen Stands: 2.20.0
...
Die gesamte Wall (Fly und Grid: Medien, Hintergrund, Banner, QR, Status) lässt sich am Gerät drehen: Auswahl unten rechts Horizontal 0° (Standard), Porträt 90°, Horizontal gedreht 180°, Porträt gedreht 270°. Speicherung im Browser (`localStorage`), nicht in der Projekt-Config. Die Auswahl selbst bleibt ungedreht, damit sie bedienbar bleibt. Gemeint für Geräte ohne echten Hochkant-Modus.
